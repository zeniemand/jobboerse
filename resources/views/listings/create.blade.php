        ...
        <div class="w-full md:w-1/2 py-24 mx-auto">
            ...
            >
                ...
                @endguest
                    ...
                    <div class="mb-4 mx-2">
                        <x-label for="location" value="Location (e.g. Remote, Germany)" />
                        <x-input
                            id="location"
                            class="block mt-1 w-full"
                            type="text"
                    ...
                    <div class="mb-4 mx-2">
                        <label for="is_highlighted" class="inline-flex items-center font-medium text-sm text-gray-700">
                            ...
                            <span class="ml-2">Highlight this post (extra 9 EUR)</span>
                        </label>
                    </div>
                <div class="mb-6 mx-2">
                    <div id="card-element">
                ...
                <div class="mb-2 mx-3">
                    ...
                    <input
                        ...
                        value=""
                    >
                    <button type="submit" id="form_submit" class="block w-full items-center bg-indigo-500 text-white border-0 py-2 focus:outline-none hover:bg-indigo-600 rounded text-base mt-4 md:mt-0">Pay and Continue</button>
                </div>
